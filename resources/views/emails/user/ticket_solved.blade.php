...
<head>
    ...
    <title>Ticket Confirmation: Your Ticket {{ $details['ticket_id'] ?? '' }} is resolved.</title>
    <!--[if (mso 16)]>
    <style type="text/css">
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="esd-block-text es-p10t es-p10b" align="center">
                                                                                        <p style="line-height: 150%;">We are pleased to inform you that your ticket has been successfully resolved. Our team has addressed the issue you reported, and we appreciate your patience throughout the process.</p>
                                                                                        <br>
                                                                                        Please note that you may receive another email shortly containing your ticket report. This report will provide you with detailed information about the resolution and any further actions taken.
                                                                                        <br>
