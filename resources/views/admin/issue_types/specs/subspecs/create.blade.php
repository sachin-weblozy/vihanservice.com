            ...
            <div class="col-12">
                <div class="card card-default">
                    <div class="card-header card-header-border-bottom">
                        <h2>Create Sub Specification</h2>
                    </div>
                        ...
                        <div class="row ec-vendor-uploads">
                            <div class="col-lg-12">
                                <div class="ec-vendor-upload-detail">
                                    <form class="row g-3" action="{{ route('admin.issue-types.subspecs.store',$spec->id) }}" method="POST" id="myForm">
                                        @csrf
                                        @method('post')
                                        <div class="col-md-12">
                                            <label for="subspec" class="form-label">Name</label>
                                            <input type="text" class="form-control slug-title" id="subspec" name="subspec">
                                        </div>
