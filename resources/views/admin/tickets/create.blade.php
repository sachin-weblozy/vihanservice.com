                        ...
                        <div class="row ec-vendor-uploads">
                            <div class="col-lg-12">
                                <div class="ec-vendor-upload-detail">
                                    <form class="row g-3" action="{{ route('admin.tickets.store') }}" method="POST" id="audioForm" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label for="name" class="form-label">Executive Name*</label>
                                                <input type="text" class="form-control slug-title" id="name" name="name" value="{{ old('name') }}" placeholder="Full Name" required>
                                            </div>
                                            <div class="col-md-3">
                                                <label for="phone" class="form-label">Phone*</label>
                                                <input type="text" class="form-control slug-title" id="phone" name="phone" value="{{ old('phone') }}" placeholder="Phone Number" required>
                                            </div>
                                            <div class="col-md-3">
                                                <label for="email" class="form-label">Email*</label>
                                                <input type="email" class="form-control slug-title" id="email" name="email" value="{{ old('email') }}" placeholder="Email Address" required>
                                            </div>
                                            <div class="col-md-3">
                                                <label for="company" class="form-label">Company*</label>
                                                <input type="text" class="form-control slug-title" id="company" name="company" value="{{ old('company') }}" placeholder="Enter Company Name" required>
                                            </div>
                                        </div>
                                        <hr><br>
                                        ...
                                        <div class="row type2">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control slug-title" id="machine_model" name="machine_model" value="{{ old('machine_model') }}" placeholder="Type Machine Model Name">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="machine_serialno" class="form-label">Machine Serial No*</label>
                                                <input type="text" class="form-control slug-title" id="machine_serialno" name="machine_serialno" value="{{ old('machine_serialno') }}" placeholder="Type Machine Serial No">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="description" class="form-control" rows="4" placeholder="Mention the Issue in Detail">{{ old('description') }}</textarea>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-md-6">
