            ...
            <div class="col-12">
                <div class="card card-default">
                    <div class="card-header card-header-border-bottom">
                        <h2>Edit Report :  {{ $report->report_number }}</h2>
                    </div>
                        ...
                        <div class="row ec-vendor-uploads">
                            <div class="col-lg-12">
                                <div class="ec-vendor-upload-detail">
                                    <form class="row g-3" action="{{ route('admin.tickets.updateReport',$report->id) }}" method="POST" id="audioForm" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <input type="hidden" name="ticketid" value="{{ $ticket->id }}">
                                            <div class="col-md-6">
                                                <label for="machine_model" class="form-label">Installed Machine*</label>
                                                <input type="text" class="form-control slug-title" id="machine_model" name="machine_model" placeholder="Type Machine Model Name" value="{{ old('machine_model',$report->machine_model) }}" required>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="machine_serialno" class="form-label">Machine Serial No*</label>
                                                <input type="text" class="form-control slug-title" id="machine_serialno" name="machine_serialno" placeholder="Type Machine Serial No" value="{{ old('machine_serialno',$report->machine_serialno) }}" required>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="name" class="form-label">Customer Name*</label>
                                                <input type="text" class="form-control slug-title" id="name" name="name" value="{{ $ticket->user->name ?? '' }}" placeholder="Full Name" value="{{ old('name',$report->name) }}" required>
                                            </div>
                                        </div>
                                        <hr><br>
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control slug-title" id="invoice_number" name="invoice_number" placeholder="Type Invoice Number" value="{{ old('invoice_number',$report->invoice_number) }}">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="invoice_date" class="form-label">Date</label>
                                                <input type="date" class="form-control slug-title" id="invoice_date" name="invoice_date" value="{{ old('invoice_date',$report->invoice_date) }}">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label for="purchase_order_number" class="form-label">Purchase Order Number(if any)</label>
                                                <input type="text" class="form-control slug-title" id="purchase_order_number" name="purchase_order_number" placeholder="Type Purchase Order Number" value="{{ old('purchase_order_number',$report->purchase_order_number) }}">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="purchase_order_date" class="form-label">Date</label>
                                                <input type="date" class="form-control slug-title" id="purchase_order_date" name="purchase_order_date" value="{{ old('purchase_order_date',$report->purchase_order_date) }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-5">
                                            ...
                                            <div class="col">
                                                <div class="form-check">
                                                    <input class="" type="radio" name="service_mode" id="onfield" value="1" @if($report->service_mode==1) checked @endif>
                                                    <label class="form-check-label" for="onfield">On Field</label>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-check">
                                                    <input class="" type="radio" name="service_mode" id="phonesupport" value="2" @if($report->service_mode==2) checked @endif>
                                                    <label class="form-check-label" for="phonesupport">Phone Support</label>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-check">
                                                    <input class="" type="radio" name="service_mode" id="remoteconnect" value="3" @if($report->service_mode==3) checked @endif>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control slug-title" id="asset_number" name="asset_number" placeholder="Type Asset Number" value="{{ old('asset_number',$report->asset_number) }}">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                @endif
                                                <input type="date" class="form-control slug-title" id="installation_date" name="installation_date" value="{{ old('installation_date',$report->installation_date) }}">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="location" class="form-label">Location</label>
                                                <input type="text" class="form-control slug-title" id="location" name="location" placeholder="Type Location" value="{{ old('location',$report->location) }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <div class="form-check">
                                                    <input class="" type="radio" name="warranty" id="remote" value="1" @if($report->under_warranty==1) checked @endif>
                                                    <label class="form-check-label" for="remote">Yes</label>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-check">
                                                    <input class="" type="radio" name="warranty" id="ic" value="2" @if($report->under_warranty==2) checked @endif>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col">
                                                <div class="form-check">
                                                    <input class="" type="radio" name="amc" id="remote" value="1"  @if($report->amc_required==1) checked @endif>
                                                    <label class="form-check-label" for="remote">Yes</label>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-check">
                                                    <input class="" type="radio" name="amc" id="ic" value="2" @if($report->amc_required==2) checked @endif>
                                                    <label class="form-check-label" for="ic">No</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            @endif
                                            <textarea class="form-control" rows="3" name="installation_note" id="tinymce-default">{{ old('installation_note',$report->installation_notes) }}</textarea>
                                        </div>
                                        <div class="col-md-12 mb-3">
                                            <label for="machine_model" class="form-label">Spare Parts Required?</label>
                                            <textarea class="form-control" rows="3" name="spare_parts" id="tinymce-default">{{ old('spare_parts',$report->spare_parts) }}</textarea>
                                        </div>
                                        <div class="col-md-12 mb-3">
                                            <label for="machine_model" class="form-label">Customer Notes</label>
                                            <textarea class="form-control" rows="3" name="customer_notes" id="tinymce-default">{{ old('customer_notes',$report->customer_notes) }}</textarea>
                                        </div>
                                        ...
                                        {{-- <div class="row mt-5">
                                            ...
                                            <div class="col-md-3 border border-primary rounded py-3 border-3">
                                                <div>
                                                    ...
                                                    <input type="text" class="form-control" id="eng1name" name="eng1name" value="{{ old('eng1name',$report->eng1_name) }}" placeholder="Enter Name" required>
                                                </div>
                                                <div>
                                                    <label for="eng1phone" class="form-label">Engineer 1 Phone*</label>
                                                    <input type="text" class="form-control" id="eng1phone" name="eng1phone" value="{{ old('location',$report->location) }}" placeholder="Enter Phone" required>
                                                </div>
                                                <div>
